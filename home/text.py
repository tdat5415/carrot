...
class Chat(models.Model):
    ...
    chat_user_a_idx = models.ForeignKey('Users', models.DO_NOTHING, db_column='chat_user_a_idx', blank=True, null=True)
    chat_user_b_idx = models.ForeignKey('Users', models.DO_NOTHING, db_column='chat_user_b_idx', blank=True, null=True)
...
class Comment(models.Model):
    ...
    comment_board_idx = models.ForeignKey('Board', models.DO_NOTHING, db_column='comment_board_idx')
